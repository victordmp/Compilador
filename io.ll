; ModuleID = 'config/io.c'
source_filename = "config/io.c"
...
define dso_local float @leiaFlutuante() #0 {
  ...
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* noundef %1)
